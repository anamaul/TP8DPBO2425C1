      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="code" value="<?php echo $course['code']; ?>" class="form-control" required>
          </div>

          <div class="mb-3">
            <label class="form-label">NAME:</label>
            <input type="text" name="name" value="<?php echo $course['name']; ?>" class="form-control" required>
          </div>

          <div class="mb-3">
            <label class="form-label">SKS:</label>
            <input type="number" name="sks" value="<?php echo $course['sks']; ?>" class="form-control" required min="1"
              max="6">
          </div>
